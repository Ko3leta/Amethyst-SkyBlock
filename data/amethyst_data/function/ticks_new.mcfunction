execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:end_portal_frame
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:lava
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:magma_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:netherrack
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:netherrack_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:obsidian
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:obsidian_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:snow
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:water
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:web
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:amethyst_s
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:amethyst_m
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:amethyst_l
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:amethyst_h
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:amethyst_geode

execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/end_portal_frame
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/lava
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/magma_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/netherrack
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/netherrack_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/obsidian
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/obsidian_fast
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/snow
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/water
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/web
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/amethyst_s
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/amethyst_m
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/amethyst_l
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/amethyst_h
execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run recipe give @s crafting:for_older_minecraft/amethyst_geode

execute as @a[gamemode=!creative,gamemode=!survival,limit=1,sort=random,tag=!started] at @s unless entity @e[tag=started2] at @s run tp @s ~0.001 ~ ~

execute as @a[gamemode=adventure,nbt=!{active_effects:[{id:"minecraft:blindness"}]}] at @s unless entity @e[tag=started2] at @s if entity @a[distance=..3,gamemode=spectator] at @s if entity @e[type=text_display,tag=welcome_sky_front,tag=anim_finale] at @s run title @s actionbar {"text":"You're choosing options now while other players're waiting for start.","color":"dark_gray"}
execute as @a[gamemode=adventure,nbt=!{active_effects:[{id:"minecraft:blindness"}]}] at @s unless entity @e[tag=started2] at @s unless entity @a[distance=..3,gamemode=spectator] at @s if entity @e[type=text_display,tag=welcome_sky_front,tag=anim_finale] at @s run title @s actionbar {"text":"You're choosing options now and there are no other waiting players.","color":"dark_gray"}
...
execute as @a[gamemode=!adventure,gamemode=!spectator,sort=random,limit=1] at @s unless entity @e[tag=started2] at @s if entity @a[distance=0.0000001..2,gamemode=adventure] at @s run gamemode spectator @s
execute as @a[gamemode=!spectator,gamemode=!adventure,sort=random,limit=1] at @s unless entity @e[tag=started2] at @s unless entity @a[distance=..2,gamemode=adventure] at @s run gamemode adventure @s

execute as @a[gamemode=adventure,sort=random,limit=1] at @s unless entity @e[tag=started2] at @s if entity @a[distance=0.0000001..2,gamemode=adventure] at @s run gamemode spectator @s
execute as @a[gamemode=spectator,sort=random,limit=1] at @s unless entity @e[tag=started2] at @s unless entity @a[distance=..2,gamemode=adventure] at @s run gamemode adventure @s


execute as @a[tag=!adv] at @s if entity @e[type=block_display,tag=settings,tag=started2] at @s run tag @s add adv
...
execute as @e[type=interaction] at @s unless entity @a[distance=..7,y_rotation=-20.9..20.9] at @s run data remove entity @s attack
...
execute as @e[type=interaction,tag=start_game_sky,limit=1] on target if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:starting_new

execute as @e[type=interaction,tag=kit_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:kit_game_sky
execute as @e[type=interaction,tag=tickrate_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:tickrate_game_sky
execute as @e[type=interaction,tag=amb_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:ambient_game_sky

execute as @e[type=interaction,tag=options_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:options
execute as @e[type=interaction,tag=credit_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:credit

execute as @e[type=interaction,tag=back_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:back

execute as @e[type=interaction,tag=title_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0},x_rotation=-30.3..-16.3] run function amethyst_data:title
execute as @e[type=interaction,tag=start_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:starting
execute as @e[type=interaction,tag=start_game_sky,limit=1] on attacker if entity @a[nbt=!{active_effects:[{id:"minecraft:blindness"}]},scores={sneak=0}] run function amethyst_data:starting_new
...
execute as @e[type=interaction] at @s if entity @e[type=text_display,nbt={default_background:false}] at @s run data remove entity @s attack
execute as @e[type=interaction] at @s if entity @a[scores={sneak=1..}] at @s run data remove entity @s attack
execute as @e[type=interaction] at @s if entity @a[nbt={active_effects:[{id:"minecraft:blindness"}]}] at @s run data remove entity @s attack
execute as @e[type=interaction] at @s unless entity @a[distance=..4,y_rotation=-20.9..20.9] at @s run data remove entity @s attack
...
execute if score @n[type=text_display,tag=welcome_sky_front,tag=!anim_finale] title_anim matches 370.. run title @a title {"text":" "}
