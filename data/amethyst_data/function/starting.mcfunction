...
execute if entity @e[type=block_display,tag=settings,tag=started_kit] run summon minecraft:item 0 15 0 {Item:{id:"minecraft:salmon_bucket",count:1},Motion:[0.0d,0.5d,0.0d]}
...
recipe give @a crafting:end_portal_frame
recipe give @a crafting:lava
recipe give @a crafting:magma_fast
recipe give @a crafting:netherrack
recipe give @a crafting:netherrack_fast
recipe give @a crafting:obsidian
recipe give @a crafting:obsidian_fast
recipe give @a crafting:snow
recipe give @a crafting:water
recipe give @a crafting:web
